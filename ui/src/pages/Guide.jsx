    ...
    <Grid>
      <Row>
        <Col md={8}>
          ...
          <p>
            {'You can browse saved questions and ask new questions without an account, but your new questions won\'t be saved. In order to save questions, you will need to '}
          ...
          <p>
            {'Currently, questions in Robokop are "asked" by specifying a path template through types of nodes in a knowledge graph. The '}
            <a href={`${config.routes.help}#questionNew`}>Help Page</a>
            {' will provide further details on asking new questions.'}
          </p>
          <hr />
          <h3>
            Getting Answers
          ...
          <p>
            {'When a question is first asked, we first try to find answers, creating what is known as an '}
            <b>Answer Set</b>
            . An answer set contains a ranked list of potential answers to your question found within our knowledge graph and prioritized using our reasoning engine.
          </p>
          ...
          <h3>Walkthrough</h3>
          <p>
            {'A comprehensive walkthrough of the application can be found at '}
            <a target="_blank" rel="noopener noreferrer" href="https://researchsoftwareinstitute.github.io/data-translator/apps/robokop">RSI Data Translator Robokop App</a>
            .
          </p>
          <hr />
          <h3>
          ...
          <ButtonToolbar style={{ marginBottom: '20px' }}>
            ...
            {shownNewQuestion ? (
              <Button bsSize="large" href={config.routes.questionDesign}>
                Ask a Question
              </Button>
            ) : (
              <Button bsSize="large" href={config.routes.simpleQuestion}>
                Ask a Quick Question
              </Button>
            )}
            {showLogIn && (
              <Button bsSize="large" href={config.routes.login}>
                Sign In / Register
              </Button>
            )}
          </ButtonToolbar>
