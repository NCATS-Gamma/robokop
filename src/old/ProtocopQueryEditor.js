...
import ProtocopQueryEditorCard from './ProtocopQueryEditorCard';
...
class ProtocopQueryEditor extends React.Component {
  // propTypes = {
...
export default ProtocopQueryEditor;
