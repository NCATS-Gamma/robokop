...
class WorkflowStep extends React.Component {
  constructor(props) {
    ...
    this.toAnswers = this.toAnswers.bind(this);
  ...
  toAnswers(question) {
    this.setState({ question }, () => this.handleTabSelect('answers'));
  }
  toExport(answer) {
    console.log('to Export')
    this.setState({ answer }, () => this.handleTabSelect('export'));
  }
  render() {
    return (
      <Tab.Container
            ...
            <Tab.Content animation>
              ...
              <Tab.Pane eventKey="answers">
                <WorkflowStepAnswers
                  ...
                  callbackToNextTab={answer => this.toExport(answer)}
                />
              </Tab.Pane>
